...
/*     */ 
/*     */     
/*  76 */     Map<Long, List<BuildingTerStatus>> map = (Map<Long, List<BuildingTerStatus>>)buildingTerStatusList.stream().collect(Collectors.toMap(BuildingTerStatus::getId, p -> {
/*     */             List<BuildingTerStatus> buildingTerStatusArrayList = new ArrayList<>();
/*     */             
/*     */             buildingTerStatusArrayList.add(p);
/*     */             
/*     */             return buildingTerStatusArrayList;
/*     */           }(value1, value2) -> {
...
/* Location:              /juyuan-iotlighting-3.8.6/!/com/ruoyi/iotlighting/service/impl/BuildingFloorInfoServiceImpl.class
